...
const Bio:FC = () => {
  return (
    <div className='bg-slate-100 p-5 rounded-lg'>
        Welcome! Check out the React <a className='underline' href="https://github.com/alec-watts/react-alecwatts.life" target="_blank" rel="noreferrer">source code</a> for this website. Below you can find the projects I have been working on with a story of their creation... Please reach out if you have any questions or would like to collaborate!
        <br />
        <br />
